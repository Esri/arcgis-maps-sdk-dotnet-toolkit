...
{
    public sealed partial class UtilityNetworkTraceToolAppearanceSample : Page
    {
        ...
        private void OnUtilityNetworkItemTemplateChanged(object sender, RoutedEventArgs e)
        {
        ...
        private void OnUtilityNetworkItemContainerStyleChanged(object sender, RoutedEventArgs e)
        {
        ...
        private void OnTraceTypeItemTemplateChanged(object sender, RoutedEventArgs e)
        {
        ...
        private void OnTraceTypeItemContainerStyleChanged(object sender, RoutedEventArgs e)
        {
            if (this.Resources["ComboBoxItemStyle1"] is Style comboBoxItemStyle)
            {
        ...
        private void OnStartingPointItemTemplateChanged(object sender, RoutedEventArgs e)
        {
        ...
        private void OnStartingPointItemContainerStyleChanged(object sender, RoutedEventArgs e)
        {
        ...
        private void OnResultItemTemplateChanged(object sender, RoutedEventArgs e)
        {
        ...
        private void OnResultItemContainerStyleChanged(object sender, RoutedEventArgs e)
        { 
            if (this.Resources["ListViewItemStyle1"] is Style listViewItemStyle)
            {
        ...
        private void OnAddStartingPointToggleButtonStyleChanged(object sender, RoutedEventArgs e)
        {
        ...
        private void OnTraceButtonStyleChanged(object sender, RoutedEventArgs e)
        {
        ...
        private void OnResetButtonStyleChanged(object sender, RoutedEventArgs e)
        {
            if (this.Resources["ButtonStyle1"] is Style buttonStyle)
            {
        ...
        private void OnBusyProgressBarStyleChanged(object sender, RoutedEventArgs e)
        {
        ...
        private void OnStatusTextBlockStyleChanged(object sender, RoutedEventArgs e)
        {
