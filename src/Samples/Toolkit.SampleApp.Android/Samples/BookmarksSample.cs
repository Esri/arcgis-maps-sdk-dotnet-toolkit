...
namespace Esri.ArcGISRuntime.Toolkit.SampleApp.Samples
{
    ...
    public class BookmarksSampleActivity : Activity
    {
        ...
        private CheckBox _prefersListCheckbox;
        private Button _SetObservableButton;
        private Button _setStaticButton;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            _prefersListCheckbox = FindViewById<CheckBox>(Resource.Id.prefersManualListCheckbox);
            ...
            _setStaticButton = FindViewById<Button>(Resource.Id.setStaticListButton);
            _SetObservableButton = FindViewById<Button>(Resource.Id.setObservableListButton);

            _prefersListCheckbox.CheckedChange += ToggleListCheckbox_Click;
            ...
            _setStaticButton.Click += ShowStaticList_Click;
        ...
        {
            bookmarksView.PrefersBookmarksList = !bookmarksView.PrefersBookmarksList;
        }

        private void ShowStaticList_Click(object sender, EventArgs e)
        {
            bookmarksView.BookmarkList = _bookmarksStatic;
        }

        private void ShowObservableList_Click(object sender, EventArgs e)
        {
            bookmarksView.BookmarkList = _bookmarksObservable;
        }
